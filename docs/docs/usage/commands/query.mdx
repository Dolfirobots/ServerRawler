...
Retrieves detailed server information using the Query (UT3/GS4) protocol.
This protocol provides more extensive data than a standard ping, including a list of online players, installed plugins, and the server's software.
