...
The Web API will provide endpoints to:

* Retrieve information about crawled servers.
* Query servers based on various criteria (e.g., player count, version, plugins).
* Potentially trigger crawling tasks or manage configurations.
